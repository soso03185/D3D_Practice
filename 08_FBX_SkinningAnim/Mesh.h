...
public:
	...
	void BindingBone(ID3D11Device* device, aiMesh* mesh);
	void UpdateMatrixPallete(Matrix* MatrixPalletePtr);
	void CreateBoneWeightVertexBuffer(ID3D11Device* device, BoneWeightVertex* vertices, UINT numVertices);
				
	ID3D11Buffer* m_pVertexBuffer;
	ID3D11Buffer* m_pIndexBuffer;
	ID3D11Buffer* m_pBoneWeightVertexBuffer;
