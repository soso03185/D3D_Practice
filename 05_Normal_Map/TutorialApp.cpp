...
void TutorialApp::CubeRender()
{
	...
	BoolBuffer bCb;
	bCb.UseNormalMap = isNormalMap;
	bCb.UseSpecularMap = isSpecularMap;
	bCb.UseGamma = isGamma;

	// 화면 칠하기.
	m_pDeviceContext->UpdateSubresource(m_pConstantBuffer, 0, nullptr, &Rcb1, 0, 0);
	m_pDeviceContext->UpdateSubresource(m_pBoolBuffer, 0, nullptr, &bCb, 0, 0);
...
///-------------------------------------------------------///
	...
	// 화면 칠하기.
	Rcb1.mWorld = XMMatrixTranspose(m_World4);
	m_pDeviceContext->UpdateSubresource(m_pConstantBuffer, 0, nullptr, &Rcb1, 0, 0);
	m_pDeviceContext->UpdateSubresource(m_pBoolBuffer, 0, nullptr, &bCb, 0, 0);
	m_pDeviceContext->DrawIndexed(m_nIndices, 0, 0);
}
...
bool TutorialApp::InitScene()
{
	...
	Vertex vertices[] =
 	{
		// 윗면
		{ Vector4(-1.0f, 1.0f, -1.0f,	1.0f),	Vector3(0.0f, 1.0f, 0.0f),  Vector2(1.0f, 0.0f), Vector3(1.f, 0.f, 0.f)},//Normal Y +	 
		{ Vector4(1.0f, 1.0f, -1.0f,	1.0f),	Vector3(0.0f, 1.0f, 0.0f),  Vector2(0.0f, 0.0f), Vector3(1.f, 0.f, 0.f)},
		{ Vector4(1.0f, 1.0f, 1.0f,		1.0f),	Vector3(0.0f, 1.0f, 0.0f),  Vector2(0.0f, 1.0f), Vector3(1.f, 0.f, 0.f)},
		{ Vector4(-1.0f, 1.0f, 1.0f,	1.0f),	Vector3(0.0f, 1.0f, 0.0f),  Vector2(1.0f, 1.0f), Vector3(1.f, 0.f, 0.f)},
		
		// 아랫면
		{ Vector4(-1.0f, -1.0f, -1.0f,	1.0f),	Vector3(0.0f, -1.0f, 0.0f), Vector2(0.0f, 0.0f), Vector3(1.f, 0.f, 0.f) },//Normal Y -		
		{ Vector4(1.0f, -1.0f, -1.0f,	1.0f),	Vector3(0.0f, -1.0f, 0.0f), Vector2(1.0f, 0.0f), Vector3(1.f, 0.f, 0.f) },
		{ Vector4(1.0f, -1.0f, 1.0f,	1.0f),	Vector3(0.0f, -1.0f, 0.0f), Vector2(1.0f, 1.0f), Vector3(1.f, 0.f, 0.f) },
		{ Vector4(-1.0f, -1.0f, 1.0f,	1.0f),	Vector3(0.0f, -1.0f, 0.0f), Vector2(0.0f, 1.0f), Vector3(1.f, 0.f, 0.f) },
																										 
		// 왼면																						   
		{ Vector4(-1.0f, -1.0f, 1.0f,	1.0f),	Vector3(-1.0f, 0.0f, 0.0f), Vector2(0.0f, 1.0f), Vector3(0.f, 1.f, 0.f) },//Normal X -
		{ Vector4(-1.0f, -1.0f, -1.0f,	1.0f),	Vector3(-1.0f, 0.0f, 0.0f), Vector2(1.0f, 1.0f), Vector3(0.f, 1.f, 0.f) },
		{ Vector4(-1.0f, 1.0f, -1.0f,	1.0f),	Vector3(-1.0f, 0.0f, 0.0f), Vector2(1.0f, 0.0f), Vector3(0.f, 1.f, 0.f) },
		{ Vector4(-1.0f, 1.0f, 1.0f,	1.0f),	Vector3(-1.0f, 0.0f, 0.0f), Vector2(0.0f, 0.0f), Vector3(0.f, 1.f, 0.f) },
																										 
		// 오른면																						   
		{ Vector4(1.0f, -1.0f, 1.0f,	1.0f),	Vector3(1.0f, 0.0f, 0.0f),  Vector2(1.0f, 1.0f), Vector3(0.f, -1.f, 0.f) },//Normal X +
		{ Vector4(1.0f, -1.0f, -1.0f,	1.0f),	Vector3(1.0f, 0.0f, 0.0f),  Vector2(0.0f, 1.0f), Vector3(0.f, -1.f, 0.f) },
		{ Vector4(1.0f, 1.0f, -1.0f,	1.0f),	Vector3(1.0f, 0.0f, 0.0f),  Vector2(0.0f, 0.0f), Vector3(0.f, -1.f, 0.f) },
		{ Vector4(1.0f, 1.0f, 1.0f,		1.0f),	Vector3(1.0f, 0.0f, 0.0f),  Vector2(1.0f, 0.0f), Vector3(0.f, -1.f, 0.f) },
																										 
		// 앞면																						   
		{ Vector4(-1.0f, -1.0f, -1.0f,	1.0f),	Vector3(0.0f, 0.0f, -1.0f), Vector2(0.0f, 1.0f), Vector3(1.f, 0.f, 0.f) },//Normal Z -
		{ Vector4(1.0f, -1.0f, -1.0f,	1.0f),	Vector3(0.0f, 0.0f, -1.0f), Vector2(1.0f, 1.0f), Vector3(1.f, 0.f, 0.f) },
		{ Vector4(1.0f, 1.0f, -1.0f,	1.0f),	Vector3(0.0f, 0.0f, -1.0f), Vector2(1.0f, 0.0f), Vector3(1.f, 0.f, 0.f) },
		{ Vector4(-1.0f, 1.0f, -1.0f,	1.0f),	Vector3(0.0f, 0.0f, -1.0f), Vector2(0.0f, 0.0f), Vector3(1.f, 0.f, 0.f) },
																										 
		// 뒷면																						   
		{ Vector4(-1.0f, -1.0f, 1.0f,	1.0f),	Vector3(0.0f, 0.0f, 1.0f),  Vector2(1.0f, 1.0f), Vector3(-1.f, 0.f, 0.f) },//Normal Z +
		{ Vector4(1.0f, -1.0f, 1.0f,	1.0f),	Vector3(0.0f, 0.0f, 1.0f),  Vector2(0.0f, 1.0f), Vector3(-1.f, 0.f, 0.f) },
		{ Vector4(1.0f, 1.0f, 1.0f,		1.0f),	Vector3(0.0f, 0.0f, 1.0f),  Vector2(0.0f, 0.0f), Vector3(-1.f, 0.f, 0.f) },
		{ Vector4(-1.0f, 1.0f, 1.0f,	1.0f),	Vector3(0.0f, 0.0f, 1.0f),  Vector2(1.0f, 0.0f), Vector3(-1.f, 0.f, 0.f) },
	};
