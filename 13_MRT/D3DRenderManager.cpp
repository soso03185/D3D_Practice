...
void D3DRenderManager::CreateIBL()
{
	...
	pComponent->ReadEnvironmentMeshFromFBX("../Resource/EnvironmentCube.fbx");
 	pComponent->ReadEnvironmentTextureFromDDS(L"../Resource/SpaceSkyBoxEnvHDR.dds");
 	pComponent->ReadIBLDiffuseTextureFromDDS(L"../Resource/SpaceSkyBoxDiffuseHDR.dds");
 	pComponent->ReadIBLSpecularTextureFromDDS(L"../Resource/SpaceSkyBoxSpecularHDR.dds");
 	pComponent->ReadIBLBRDFTextureFromDDS(L"../Resource/SpaceSkyBoxBrdf.dds");
