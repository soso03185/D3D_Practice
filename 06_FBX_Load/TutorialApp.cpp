...
void TutorialApp::Update()
{
	...
	// Left
	m_LeftWorld = mScale * XMMatrixRotationY(t * 4.0f) * XMMatrixRotationZ(-t * 4.0f);
...
///-------------------------------------------------------///
	...
	// 화면 칠하기.
	CB_Transform.mWorld = XMMatrixTranspose(m_LeftWorld);
...
bool TutorialApp::InitScene()
{
	...
	const aiScene* fbxModel = importer.ReadFile("../Resource/zeldaPosed001.fbx", importFlags);
